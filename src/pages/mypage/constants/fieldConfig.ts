...
const configArr: Array<{
  ...
  { key: "nickname", label: "닉네임",    placeholder: "텍스트를 입력해 주세요", helperText: "메세지에 마침표를 찍어요" },
  { key: "name",     label: "이름",      placeholder: "이름을 입력해 주세요",helperText: "메세지에 마침표를 찍어요" },
  { key: "gender",   label: "성별",      placeholder: "성별을 입력해 주세요",helperText: "메세지에 마침표를 찍어요" },
  { key: "birthDate",label: "생년월일",  placeholder: "YYYY.MM.DD", helperText: "메세지에 마침표를 찍어요" },
];
